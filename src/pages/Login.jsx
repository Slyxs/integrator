    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-cream px-4">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-coffee">Iniciar Sesión</h1>
        ...
        <div className="mt-4 p-4 bg-gray-50 rounded-lg text-sm">
          <p className="font-medium text-gray-700 mb-2">Cuentas de prueba:</p>
          <p className="text-gray-500">Admin: admin@juanvaldez.com / admin123</p>
          <p className="text-gray-500">Usuario: usuario@juanvaldez.com / user123</p>
        </div>
